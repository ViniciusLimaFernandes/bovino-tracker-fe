...
} from "./chunk-QCVKCKDV.js";
import "./chunk-EE6GTNRQ.js";
import {
  PublicKey,
...
// node_modules/@solana/wallet-adapter-blocto/lib/esm/adapter.js
init_index_browser_esm();
var BloctoWalletName = "Blocto";
var BloctoWalletAdapter = class extends BaseWalletAdapter {
  constructor(config = {}) {
    super();
  ...
  async connect() {
    try {
      ...
      let BloctoClass;
      try {
        BloctoClass = (await import("./blocto-sdk.module-NQ7I7SRN.js")).default;
      } catch (error) {
...
// node_modules/@solana/wallet-adapter-brave/lib/esm/adapter.js
init_index_browser_esm();
var BraveWalletName = "Brave";
var BraveWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
...
// node_modules/@solana/wallet-adapter-exodus/lib/esm/adapter.js
init_index_browser_esm();
var ExodusWalletName = "Exodus";
var ExodusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
...
// node_modules/@solana/wallet-adapter-fake/lib/esm/adapter.js
init_index_browser_esm();
var FakeWalletName = "Fake Wallet";
var FakeWalletAdapter = class extends BaseWalletAdapter {
  constructor() {
    super();
    ...
    this._publicKey = null;
    console.warn("Your application is presently configured to use the `FakeWalletAdapter`. Find and remove it, then replace it with a list of adapters for wallets you would like your application to support. See https://github.com/solana-labs/wallet-adapter#usage for an example.");
  }
  get connecting() {
    return false;
  }
  ...
  async sendTransaction(transaction, connection, options = {}) {
    console.debug("FakeWallet: `sendTransaction()` was called. Transaction was not actually sent to the network. Returning `itsFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFake` as the signature.");
    return "itsFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFakeFake";
  }
};

// node_modules/@solana/wallet-adapter-glow/lib/esm/adapter.js
init_index_browser_esm();
var GlowWalletName = "Glow";
var GlowWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        TransportWebHIDClass = (await import("./TransportWebHID-CIQTRWQG.js")).default;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let transport;
...
// node_modules/@solana/wallet-adapter-magiceden/lib/esm/adapter.js
init_index_browser_esm();
var MagicEdenWalletName = "Magic Eden";
var MagicEdenWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor({ network = WalletAdapterNetwork.Mainnet } = {}) {
    ...
    this.url = "https://www.salmonwallet.io";
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("./esm-BKYQUFEE.js")).default;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let wallet;
...
// node_modules/@solana/wallet-adapter-slope/lib/esm/adapter.js
init_index_browser_esm();
var import_bs582 = __toESM(require_bs58(), 1);
var SlopeWalletName = "Slope";
var SlopeWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
  ...
  async signTransaction(transaction) {
    try {
      ...
      if (!wallet)
        throw new WalletNotConnectedError();
      try {
        const message = import_bs582.default.encode(transaction.serializeMessage());
        const { msg, data } = await wallet.signTransaction(message);
        if (!data.publicKey || !data.signature)
          throw new WalletSignTransactionError(msg);
        const publicKey = new PublicKey(data.publicKey);
        const signature = import_bs582.default.decode(data.signature);
        transaction.addSignature(publicKey, signature);
        return transaction;
      } catch (error) {
        if (error instanceof WalletError)
  ...
  async signAllTransactions(transactions) {
    try {
      ...
      if (!wallet)
        throw new WalletNotConnectedError();
      try {
        const messages = transactions.map((transaction) => import_bs582.default.encode(transaction.serializeMessage()));
        ...
        for (let i = 0; i < length; i++) {
          transactions[i].addSignature(publicKey, import_bs582.default.decode(data.signatures[i]));
        }
        return transactions;
      } catch (error) {
        if (error instanceof WalletError)
  ...
  async signMessage(message) {
    try {
      ...
      try {
        ...
        return import_bs582.default.decode(response.data.signature);
      } catch (error) {
        throw new WalletSignMessageError(error?.message, error);
      }
    } catch (error) {
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./esm-DADD5LF3.js")).default;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let wallet;
...
// node_modules/@solana/wallet-adapter-sollet/lib/esm/base.js
init_index_browser_esm();
var BaseSolletWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        SolWalletAdapterClass = (await import("./esm-X5ADRI7H.js")).default;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let wallet;
...
// node_modules/@solana/wallet-adapter-sollet/lib/esm/adapter.js
var SolletWalletName = "Sollet";
var SolletWalletAdapter = class extends BaseSolletWalletAdapter {
...
var SolletExtensionWalletName = "Sollet (Extension)";
var SolletExtensionWalletAdapter = class extends BaseSolletWalletAdapter {
  constructor() {
    super(...arguments);
...
// node_modules/@solana/wallet-adapter-strike/lib/esm/adapter.js
var StrikeWalletName = "Strike";
var StrikeWalletAdapter = class extends BaseSignerWalletAdapter {
  constructor(config = {}) {
    super();
  ...
  async connect() {
    try {
      ...
      let StrikeClass;
      try {
        StrikeClass = (await import("./esm-WWCB7R66.js")).StrikeWallet;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("./solanaEmbed.esm-IRWFWFXO.js")).default;
      } catch (error) {
        throw new WalletLoadError(error?.message, error);
      }
      let wallet;
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("./dist-KMYDHX6N.js");
